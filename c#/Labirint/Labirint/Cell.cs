...
namespace Labirint
{
    ...
    class Cell
    {
        ...
        public Dictionary<CellType, int> Kadrs = new Dictionary<CellType, int>();
        public object obj;
        public int Damage = 0;
        ...
        public Cell(Random rnd)
        {
            ...
            Kadrs.Add(CellType.Empty, rnd.Next(4));
        ...
        public void RePaint()
        {
            ...
            g.DrawImage(Properties.Resources.Floor,
                new Rectangle(0, 0, img.Width, img.Height),
                new Rectangle(
                    Kadrs[CellType.Empty]*img.Width, 0, 
